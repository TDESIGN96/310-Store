...
<template>
  <div class="flex flex-col gap-6">
    ...
    <template v-else>
          ...
          <div class="grid gap-3 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <Input v-model="productSearch" class="ps-9" :placeholder="t('invoices_page.product_search_placeholder')" :disabled="!draft.warehouse_id" />
              </div>
      ...
      <Card class="gap-0 overflow-hidden py-0 shadow-sm">
        <div class="border-b bg-section-terms border-section-terms text-Black px-4 py-3.5 sm:px-6"><h2 class="text-base font-semibold">{{ t('invoices_page.terms_section') }}</h2></div>
        <CardContent class="px-4 py-5 sm:px-6 sm:py-6">
          <details class="rounded-lg border px-4 py-3">
            ...
            <div class="mt-3">
              <RichTextEditor
                v-model="draft.terms"
                :placeholder="t('invoices_page.terms_placeholder')"
      ...
      <Card class="gap-0 overflow-hidden py-0 shadow-sm">
        <div class="border-b bg-section-notes border-section-notes text-Black px-4 py-3.5 sm:px-6"><h2 class="text-base font-semibold">{{ t('invoices_page.notes_section') }}</h2></div>
        <CardContent class="px-4 py-5 sm:px-6 sm:py-6">
          <details class="rounded-lg border px-4 py-3">
            ...
            <div class="mt-3">
              <RichTextEditor
                v-model="draft.notes"
                :placeholder="t('invoices_page.notes_placeholder')"

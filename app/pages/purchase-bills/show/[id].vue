                ...
                <TableBody>
                  ...
                  >
                    <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
                      <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('purchase_bills_page.col_product') }}</span>
                    ...
                    <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
                      <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('purchase_bills_page.variation') }}</span>
                    ...
                    <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4 md:text-end">
                      <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('purchase_bills_page.qty') }}</span>
                      <span class="tabular-nums">{{ asNumber(item.qty) }}</span>
                    </TableCell>
                    <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4 md:text-end">
                      <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('purchase_bills_page.unit_price') }}</span>
                      <span class="tabular-nums">{{ money(item.unit_price) }}</span>
                    </TableCell>
                    <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4 md:text-end">
                      <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('purchase_bills_page.discount_percentage') }}</span>
                      <span class="tabular-nums">{{ money(itemDiscountPercentage(item)) }}</span>
                    </TableCell>
                    <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4 md:text-end">
                      <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('purchase_bills_page.line_discount') }}</span>
                      <span class="tabular-nums">{{ money(itemLineDiscount(item)) }}</span>
                    </TableCell>
                    <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4 md:text-end">
                      <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('purchase_bills_page.row_total') }}</span>

          ...
          <div class="grid gap-5 md:grid-cols-2">
            ...
            <div class="space-y-2">
              ...
              <Select :model-value="draft.warehouse_id ? String(draft.warehouse_id) : ''" @update:model-value="value => draft.warehouse_id = Number(value) || null">
                <SelectTrigger class="w-full"><SelectValue :placeholder="t('transport_invoices_page.select_warehouse')" /></SelectTrigger>
                <SelectContent>
        ...
        <CardContent class="space-y-4 px-4 py-5 sm:px-6 sm:py-6">
          <div class="grid gap-3 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div class="relative"><Search class="pointer-events-none absolute start-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground" /><Input v-model="productSearch" class="ps-9" :placeholder="t('transport_invoices_page.product_search_placeholder')" /></div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative"><Barcode class="pointer-events-none absolute start-3 top-1/2 size-4 -translate-y-1/2 text-muted-foreground" /><Input v-model="barcodeInput" class="ps-9" :placeholder="t('transport_invoices_page.barcode_placeholder')" @keydown.enter.prevent="handleBarcodeSubmit" /></div>
              <Button type="button" variant="outline" class="w-full gap-2 md:w-auto" :disabled="loadingProducts" @click="showAllProducts"><Loader2 v-if="loadingProducts" class="size-4 animate-spin" /><span>{{ t('transport_invoices_page.products') }}</span></Button>
            </div>
          </div>

  ...
  <div class="flex flex-col gap-6">
    ...
    <template v-else-if="invoice">
      <Card class="gap-0 overflow-hidden py-0 shadow-sm">
        <div class="flex items-center gap-2 border-b bg-muted/40 px-4 py-3.5 sm:px-6"><FileText class="size-4 text-muted-foreground" /><h2 class="text-base font-semibold">{{ t('transport_invoices_page.details_section') }}</h2></div>
        <CardContent class="grid gap-4 px-4 py-5 sm:grid-cols-2 sm:px-6 sm:py-6">
          ...
          <div><p class="text-xs text-muted-foreground">{{ t('transport_invoices_page.shipment_code') }}</p><p class="text-sm font-medium">{{ invoice.shipment_code || '—' }}</p></div>
          <div><p class="text-xs text-muted-foreground">{{ t('transport_invoices_page.shipment_status') }}</p><p class="text-sm font-medium">{{ invoice.shipment_status ?? '—' }}</p></div>
          ...
          <div><p class="text-xs text-muted-foreground">{{ t('transport_invoices_page.customer_email') }}</p><p class="text-sm">{{ invoice.customer_email || '—' }}</p></div>
      ...
      <Card class="gap-0 overflow-hidden py-0 shadow-sm">
        <div class="flex items-center gap-2 border-b bg-muted/40 px-4 py-3.5 sm:px-6"><Package class="size-4 text-muted-foreground" /><h2 class="text-base font-semibold">{{ t('transport_invoices_page.items_section') }}</h2></div>
      ...
      <Card class="gap-0 overflow-hidden py-0 shadow-sm"><div class="border-b bg-muted/40 px-4 py-3.5 sm:px-6"><h2 class="text-base font-semibold">{{ t('transport_invoices_page.terms_section') }}</h2></div><CardContent class="px-4 py-5 text-sm sm:px-6 sm:py-6"><p>{{ invoice.terms || '—' }}</p></CardContent></Card>
      <Card class="gap-0 overflow-hidden py-0 shadow-sm"><div class="border-b bg-muted/40 px-4 py-3.5 sm:px-6"><h2 class="text-base font-semibold">{{ t('transport_invoices_page.notes_section') }}</h2></div><CardContent class="px-4 py-5 text-sm sm:px-6 sm:py-6"><p>{{ invoice.notes || '—' }}</p></CardContent></Card>

      ...
      <div class="brand-panel">
        <div class="brand-panel-inner">
          ...
          <div class="module-pills">
            <div class="pill anim-pop" v-for="(m, i) in modulePills" :key="m" :style="`--delay: ${0.6 + i * 0.08}s`">{{
              m }}</div>
          </div>
        ...
        <div class="login-card anim-card">
          ...
          <div class="login-form">
            ...
            <button class="login-btn anim-fade-up"  :class="{ loading: isLoading }"
              @click="handleLogin" :disabled="isLoading" linkto="/dashboard">
...
.pill:hover {
  background: rgba(255, 255, 255, 0.15);
  border-color: rgba(207, 224, 48, 0.4);
  color: #CFE030;
}
...
@keyframes textGlow {
  ...
  0%,
  100% {
    text-shadow: 0 0 40px rgba(207, 224, 48, 0.3);
  }

  50% {
    text-shadow: 0 0 80px rgba(207, 224, 48, 0.5), 0 0 120px rgba(207, 224, 48, 0.2);
  }
}

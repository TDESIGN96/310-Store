        ...
        <Table>
          ...
          <TableBody>
            ...
            <TableRow
              ...
              v-bind="bindRow({ onLongPress: () => toggleSelect(row.id), onTap: () => (selectedCount > 0 ? toggleSelect(row.id) : navigateRow(`/quotations/show/${row.id}`)) })"
            >
              ...
              <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
                <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('quotations_page.col_ref_id') }}</span>
                <NuxtLink
              ...
              <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
                <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('quotations_page.col_customer') }}</span>
              ...
              <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
                <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('quotations_page.col_issue_date') }}</span>
                <span class="text-sm tabular-nums">{{ fmtDate(row.issue_date) }}</span>
              </TableCell>
              <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
                <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('quotations_page.col_due_date') }}</span>
                <span class="text-sm tabular-nums">{{ fmtDate(row.expiry_date) }}</span>
              </TableCell>
              <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
              ...
              <TableCell class="flex justify-between items-start gap-2 py-1.5 md:table-cell md:py-4">
                <span class="text-xs font-medium text-muted-foreground md:hidden">{{ t('quotations_page.col_discount_amount') }}</span>
